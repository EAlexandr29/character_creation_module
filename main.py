"""Модуль, позволяющий тренировать выбранного персонажа."""
...
def special(char_name: str, char_class: str) -> str:
    """Функция для тренировки применения специального приема."""
    if char_class == 'warrior':
        special_damage: int = 80 + 25
        return (f'{char_name} применил специальное'
                f' умение «Выносливость {special_damage}»')
    if char_class == 'mage':
        special_damage = 5 + 40
        return (f'{char_name} применил специальное'
                f' умение «Атака {special_damage}»')
    if char_class == 'healer':
        special_damage = 10 + 30
        return (f'{char_name} применил специальное'
                f' умение «Защита {special_damage}»')
    return (f'{char_name} не применил специальное умение')


def start_training(char_name: str, char_class: str) -> str:
    """Функция для выбора тренировки."""
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack — чтобы атаковать противника, '
          ...
          'тобы использовать свою суперсилу.')
